<template>
    <div class="box">
      ...
      <select v-else v-model="display.knowledgePoint" class="dropdown" style="width: 160px; height: auto;">
      ...
      <div class="input-wrapper">
        <textarea v-model="display.questionStem" :placeholder="display.questionStem" style="border:0;border-radius:5px;background-color:rgba(241,241,241,.98);height:90px;padding:10px;resize:none;" placeholder="题目返回区" class="input-field" />
      </div>
      <button v-if="!display.questionStem" @click="changeQuestionStem('123')">生成题目</button>
